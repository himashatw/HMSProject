			...
			<div class="col-md-9 ftco-animate text-center">
				...
				<p class="breadcrumbs">
					<span class="mr-2"><a href="index.jsp">Home <i
						...
						class="ion-ios-arrow-forward"></i></a></span><span> Doctors List <i
		...
		<tbody>
			...
			<c:forEach var="doctor" items="${listDoctors}">
				...
				<tr>
					...
					<td><a href="DoctorFormDataController?dID=<c:out value='${doctor.dID}' />">Edit</a>
						&nbsp;&nbsp;&nbsp;&nbsp; <a
						href="DoctorDeleteController?dID=<c:out value='${doctor.dID}' />">Delete</a></td>
				</tr>
			</c:forEach>
