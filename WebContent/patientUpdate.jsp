	...
	<div class="container">
		<div
			...
			<div class="col-md-9 ftco-animate text-center">
				<h1 class="mb-2 bread">Update ${existingPatient.name }</h1>
				<p class="breadcrumbs">
					<span class="mr-2"><a href="index.jsp">Home <i
							class="ion-ios-arrow-forward"></i></a></span> <span><a href="dashboard.jsp">${adminEmail } <i
						class="ion-ios-arrow-forward"></i></a></span><span><a href="listPatients"> Patients List <i
						class="ion-ios-arrow-forward"></i></a></span><span> Update Patient <i
	...
	<div class="container">
		<div class="row d-flex align-items-stretch no-gutters">
			<div class="col-md-6 p-4 p-md-5 order-md-last bg-light">
				...
				<form action="PatientUpdateController" method="get">
					<div class="form-group">
					Patient ID (Patiend ID Can not be Changed) :	<input type="text" name="pID" class="form-control" value="${existingPatient.pID}" readonly>
					</div>
					<div class="form-group">
					Name :	<input type="text" name="name" class="form-control" value="${existingPatient.name}">
					</div>
					<div class="form-group">
					Age :	<input type="text" name="age" class="form-control" value="${existingPatient.age}">
					</div>
					<div class="form-group">
					Contact :	<input type="text" name="contact" class="form-control" value="${existingPatient.contact}">
					</div>
					<div class="form-group">
					Email :	<input type="text" name="email" class="form-control" value="${existingPatient.email}">
					</div>
					<div class="form-group">
					Password :	<input type="text" name="password" class="form-control" value="${existingPatient.password}">
					</div>
