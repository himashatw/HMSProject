			...
			<div class="col-md-9 ftco-animate text-center">
				...
				<p class="breadcrumbs">
					<span class="mr-2"><a href="index.jsp">Home <i
						...
						class="ion-ios-arrow-forward"></i></a></span><span> Appointments <i
		...
		<tbody>
			...
			<c:forEach var="appointment" items="${listAppointments}">
				...
				<tr>
					...
					<td><c:out value="${appointment.details}" /></td>
					<td><c:out value="${appointment.appTime}" /></td>
					<td><c:out value="${appointment.pID}" /></td>
					<td><c:out value="${appointment.dID}" /></td>
