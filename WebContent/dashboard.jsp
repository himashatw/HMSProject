...
%>
	...
	<div class="container d-flex align-items-center">
		...
		<p class="button-custom order-lg-last mb-0">
			<a href="logoutAcontroller" class="btn btn-secondary py-2 px-3">Log Out</a>
		</p>
			...
			<div class="col-md-9 ftco-animate text-center">
				...
				<p class="breadcrumbs">
					<span class="mr-2"><a href="index.jsp">Home <i
							class="ion-ios-arrow-forward"></i></a></span> <span>${adminEmail } <i
...
<div id="app">
		...
		<div class="app-content">
			...
			<div class="main-content" style="margin-right:220px;">
						...
						<div class="row">
								...
								<div class="panel panel-white no-radius text-center">
									<div class="panel-body">
										...
										<p class="links cl-effect-1">
											<a href="listPatients"> Patients List </a>
										</p>
									</div>
								</div>
							</div>
							<div class="col-sm-4">
								<div class="panel panel-white no-radius text-center">
									<div class="panel-body">
										...
										<p class="cl-effect-1">
											<a href="DoctorListController"> Doctors List </a>
										</p> 
									</div>
								</div>
							</div>
							<div class="col-sm-4">
								<div class="panel panel-white no-radius text-center">
									<div class="panel-body">
										<span class="fa-stack fa-2x"> <i
											class="fa fa-user-plus fa-stack-2x text-primary"></i> <i
											class="fa fa-terminal fa-stack-1x fa-inverse"></i>
										</span>
										<h2 class="StepTitle">Add Doctor</h2>

										<p class="links cl-effect-1">
											<a href="doctorRegister.jsp"> Doctor Registration </a>
										</p>
									</div>
								</div>
							</div>
							...
							<div class="col-sm-4">
								<div class="panel panel-white no-radius text-center">
									<div class="panel-body">
										<span class="fa-stack fa-2x"> <i
											class="fa fa-history fa-stack-2x text-primary"></i> <i
											class="fa fa-terminal fa-stack-1x fa-inverse"></i>
										</span>
										<h2 class="StepTitle">Appointments</h2>

										<p class="links cl-effect-1">
											<a href="AppointmentListController"> Appointment List </a>
										</p>
									</div>
								</div>
							</div>
							<div class="col-sm-4">
								<div class="panel panel-white no-radius text-center">
									<div class="panel-body">
										<span class="fa-stack fa-2x"> <i
											class="fa fa-bell fa-stack-2x text-primary"></i> <i
											class="fa fa-user fa-stack-1x fa-inverse"></i>
										</span>
										<h2 class="StepTitle">Queries</h2>

										<p class="links cl-effect-1">
											<a href="QueryListController"> Query List </a>
										</p>
									</div>
								</div>
							</div>
