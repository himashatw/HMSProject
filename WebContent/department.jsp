	...
	<div class="container d-flex align-items-center">
		...
		<div class="collapse navbar-collapse" id="ftco-nav">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item active"><a href="department.jsp"
			...
			<div class="row">
				<div class="col-md-12 nav-link-wrap">
					<div class="nav nav-pills d-flex text-center" id="v-pills-tab"
						...
						<a class="nav-link ftco-animate" id="v-pills-5-tab"
				...
				<div class="col-md-12 tab-wrap">
					...
					<div class="tab-content bg-light p-4 p-md-5 ftco-animate"
