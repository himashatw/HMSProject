	...
	<div class="container">
		<div
			...
			<div class="col-md-9 ftco-animate text-center">
				<h1 class="mb-2 bread">Patient Login</h1>
				<p class="breadcrumbs">
	...
	<div class="container">
		<div class="row d-flex align-items-stretch no-gutters">
			<div class="col-md-6 p-4 p-md-5 order-md-last bg-light">
				...
				<form action="LoginPcontroller" method="get">
					<div class="form-group">
						<input type="text" name="patEmail" class="form-control" placeholder="Your Email">
					</div>
					<div class="form-group">
						<input type="text" name="patPass" class="form-control" placeholder="Password">
					</div>
