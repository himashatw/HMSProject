	...
	<div class="container">
		<div
			...
			<div class="col-md-9 ftco-animate text-center">
				<h1 class="mb-2 bread">Update ${existingDoctor.name }</h1>
				<p class="breadcrumbs">
					<span class="mr-2"><a href="index.jsp">Home <i
							class="ion-ios-arrow-forward"></i></a></span> <span><a href="dashboard.jsp">${adminEmail } <i
						class="ion-ios-arrow-forward"></i></a></span><span><a href="DoctorListController"> Doctors List <i
						class="ion-ios-arrow-forward"></i></a></span><span> Update Doctor <i
	...
	<div class="container">
		<div class="row d-flex align-items-stretch no-gutters">
			<div class="col-md-6 p-4 p-md-5 order-md-last bg-light">
				...
				<form action="DoctorUpdateController" method="get">
					<div class="form-group">
					Doctor ID (Doctor ID can not be Changed) :	<input type="text" name="dID" class="form-control" value="${existingDoctor.dID}" readonly>
					</div>
					<div class="form-group">
					Name :	<input type="text" name="name" class="form-control" value="${existingDoctor.name}">
					</div>
					<div class="form-group">
					Contact :	<input type="text" name="contact" class="form-control" value="${existingDoctor.contact}">
					</div>
					<div class="form-group">
					Specialization :	<input type="text" name="specialization" class="form-control" value="${existingDoctor.specialization}">
					</div>
					<div class="form-group">
					Time :	<input type="text" name="time" class="form-control" value="${existingDoctor.time}">
					</div>
					<div class="form-group">
					Email :	<input type="text" name="email" class="form-control" value="${existingDoctor.email}">
					</div>
					<div class="form-group">
					Password :	<input type="text" name="password" class="form-control" value="${existingDoctor.password}">
					</div>
