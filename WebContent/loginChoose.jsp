...
<body>
	...
	<div class="container">
		<div
			...
			<div class="col-md-9 ftco-animate text-center">
				<h1 class="mb-2 bread">Login Account</h1>
				<p class="breadcrumbs">
					<span class="mr-2"><a href="index.jsp">Home <i
							class="ion-ios-arrow-forward"></i></a></span> <span>Choose Login
						Account <i class="ion-ios-arrow-forward"></i>
					</span>
				</p>
			</div>
		</div>
	...
	<div class="form-group" style="margin-top: 50px; margin-bottom: 50px">
		<button class="btn btn-primary py-3 px-5" style="margin-left: 650px;"
			onclick="window.location.href = 'loginD.jsp';">Doctor Login</button>
	</div>
	<div class="form-group" style="margin-top: 50px; margin-bottom: 50px">
		<button class="btn btn-primary py-3 px-5" style="margin-left: 650px;"
			onclick="window.location.href = 'loginP.jsp';">Patient Login</button>
	</div>
	<div class="form-group" style="margin-top: 50px; margin-bottom: 50px">
		<button class="btn btn-primary py-3 px-5" style="margin-left: 650px;"
			onclick="window.location.href = 'loginA.jsp';">Admin Login</button>
	</div>
