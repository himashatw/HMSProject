	...
	<div class="container">
		<div
			...
			<div class="col-md-9 ftco-animate text-center">
				<h1 class="mb-2 bread">Queries</h1>
				<p class="breadcrumbs">
					<span class="mr-2"><a href="index.jsp">Home <i
							class="ion-ios-arrow-forward"></i></a></span> <span><a href="dashboard.jsp">${adminEmail } <i
						class="ion-ios-arrow-forward"></i></a></span><span> Queries List <i
...
<div style="padding-right:100px;padding-left:100px;padding-top:3%;padding-bottom:3%;text-align:center;font-weight:500;">
	<table class="table table-bordered">
		...
		<tbody>
			...
			<c:forEach var="query" items="${listQueries}">

				<tr>
					<td><c:out value="${query.qID}" /></td>
					<td><c:out value="${query.name}" /></td>
					<td><c:out value="${query.email}" /></td>
					<td><c:out value="${query.subject}" /></td>
					<td><c:out value="${query.message}" /></td>
					<td><c:out value="${query.time}" /></td>
					<td><a href="mailto:<c:out value='${query.email}' />">Response</a>
						&nbsp;&nbsp;&nbsp;&nbsp; <a
						href="QueryDeleteController?qID=<c:out value='${query.qID}' />">Delete</a></td>
				</tr>
			</c:forEach>
