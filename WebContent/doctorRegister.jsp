	...
	<div class="container">
		<div
			...
			<div class="col-md-9 ftco-animate text-center">
				<h1 class="mb-2 bread">Doctor Registration</h1>
				<p class="breadcrumbs">
					<span class="mr-2"><a href="index.jsp">Home <i
							class="ion-ios-arrow-forward"></i></a></span> <span><a href="dashboard.jsp">${adminEmail } <i
						class="ion-ios-arrow-forward"></i></a></span><span> Register Doctor <i
...
<div style="padding-left:500px;padding-top:3%;padding-bottom:3%;text-align:center;font-weight:500;">
	
	<section class="ftco-section ftco-no-pt ftco-no-pb contact-section">
	<div class="container">
		<div class="row d-flex align-items-stretch no-gutters">
			<div class="col-md-6 p-4 p-md-5 order-md-last bg-light">
				<form action="DoctorInsertController">
					<div class="form-group">
						<input type="text" name="name" class="form-control" placeholder="Doctor Name">
					</div>
					<div class="form-group">
						<input type="text" name="contact" class="form-control" placeholder="Doctor Contact">
					</div>
					<div class="form-group">
						<input type="text" name="specialization" class="form-control" placeholder="Doctor Specialization">
					</div>
					<div class="form-group">
						<input type="text" name="time" class="form-control" placeholder="Doctor Available Time">
					</div>
					<div class="form-group">
						<input type="text" name="email" class="form-control" placeholder="Doctor Email">
					</div>
					<div class="form-group">
						<input type="text" name="password" class="form-control" placeholder="Doctor Password">
					</div>
