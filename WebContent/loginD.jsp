	...
	<div class="container">
		<div class="row d-flex align-items-stretch no-gutters">
			<div class="col-md-6 p-4 p-md-5 order-md-last bg-light">
				...
				<form action="LoginDcontroller" method="get">
					<div class="form-group">
						<input type="text" name="docEmail" class="form-control" placeholder="Your Email">
					</div>
					<div class="form-group">
						<input type="text" name="docPass" class="form-control" placeholder="Password">
					</div>
