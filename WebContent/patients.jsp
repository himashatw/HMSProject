	...
	<div class="container">
		<div
			...
			<div class="col-md-9 ftco-animate text-center">
				<h1 class="mb-2 bread">Patients</h1>
				<p class="breadcrumbs">
					<span class="mr-2"><a href="index.jsp">Home <i
							class="ion-ios-arrow-forward"></i></a></span> <span><a href="dashboard.jsp">${adminEmail } <i
						class="ion-ios-arrow-forward"></i></a></span><span> Patients List <i
		...
		<tbody>
			...
			<c:forEach var="patient" items="${listPatients}">
				...
				<tr>
					...
					<td><a href="PatientFormDataController?pID=<c:out value='${patient.pID}' />">Edit</a>
						&nbsp;&nbsp;&nbsp;&nbsp; <a
						href="PatientDeleteController?pID=<c:out value='${patient.pID}' />">Delete</a></td>
				</tr>
			</c:forEach>
